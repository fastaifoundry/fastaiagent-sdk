...
sample_trace = TraceData(
    ...
    spans=[
        SpanData(span_id="s1", trace_id="demo_trace_001", name="agent.run",
                 start_time="2025-01-15T10:00:00Z", end_time="2025-01-15T10:00:05Z"),
        SpanData(span_id="s2", trace_id="demo_trace_001", name="llm.completion",
                 start_time="2025-01-15T10:00:00.5Z", end_time="2025-01-15T10:00:02Z",
                 parent_span_id="s1"),
        SpanData(span_id="s3", trace_id="demo_trace_001", name="tool.search",
                 start_time="2025-01-15T10:00:02.1Z", end_time="2025-01-15T10:00:03Z",
                 parent_span_id="s1"),
        SpanData(span_id="s4", trace_id="demo_trace_001", name="llm.completion",
                 start_time="2025-01-15T10:00:03.1Z", end_time="2025-01-15T10:00:04.5Z",
                 parent_span_id="s1",
